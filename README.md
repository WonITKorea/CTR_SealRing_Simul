...
The app now supports a live USB input mode for an NI `cDAQ-SL1100` bundle.
...
5. For NI 9237 modules, the default sample rate is set to `1612.903 S/s`, which avoids the `-201087` on-demand sampling error.
6. Start monitoring. The single load-cell value is mirrored into all 6 axes.
